...
public class ClienteRepository {
	...
	public void create(Cliente cliente) throws Exception {
		...
		PreparedStatement statement = connection.prepareStatement("insert into cliente(id, nome, email, telefone) values(?,?,?,?)");
	...
	public void update(Cliente cliente) throws Exception {
		...
		// executando um comando sql (query) para atualizar um cliente na tabela do
		// banco
	...
	public List<Cliente> findAll() throws Exception {
		...
		// executando o comando sql (query) para consultar todos os clientes na tabela
		// do banco
	...
	public Cliente findById(UUID id) throws Exception {
		...
		Cliente cliente = null; // Inicializando como null, pois preciso atribuir um valor a minha variável quando a declaro.

		if (resultSet.next()) { //Se existe iD, então...

			cliente = new Cliente(); // instanciando o cliente (Criando espaço em memória)
//Preciso preencher para o java ler as informações do banco de dados do cliente
			cliente.setId(UUID.fromString(resultSet.getString("id")));
			cliente.setNome(resultSet.getString("nome"));
			cliente.setEmail(resultSet.getString("email"));
			cliente.setTelefone(resultSet.getString("telefone"));
